              ...
              content: (
                <>
                  ...
                  <div className="flex items-center mb-3">
                    <img src="/qr.jpg" alt="QR Code" className="w-20 h-20 object-contain" />
                    <div className="flex flex-col ml-3">
                      <img src="/google.png" alt="Google Play" className="w-28 h-8" />
                      <img src="/applelogo.png" alt="App Store" className="w-24 h-8 mt-1" />
                    </div>
                  </div>
